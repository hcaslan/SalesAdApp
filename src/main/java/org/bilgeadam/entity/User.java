...
public class User {
    ...
    @OneToMany(mappedBy = "message_sender_id", cascade = CascadeType.PERSIST,fetch = FetchType.EAGER)
    List<Message> sendMessages;

    @OneToMany(mappedBy = "message_receiver_id", cascade = CascadeType.PERSIST,fetch = FetchType.EAGER)
